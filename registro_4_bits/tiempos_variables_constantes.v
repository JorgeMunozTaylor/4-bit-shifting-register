...
`define NumPwrCntr      23      //numero de contadores N, menos uno: NumPwrCntr = N - 1
`define Ndir            4       //(2^(Ndir+1) - 1) > NumPwrCntr
`define TIEMPO          1800    //Tiempo que dura la simulacion
...
`define t_final 1000    /*Indica cuando se dejan de mapear las senales en GTKWAVE*/
`define CLK_t1  25.15   /*Ancho del pulso en la prueba 1*/
`define CLK_t2  25.15   /*Ancho del pulso en la prueba 2*/
`define CLK_t3  66.6    /*Ancho del pulso en la prueba 3*/
`define CLK_t4  66.6    /*Ancho del pulso en la prueba 4*/
`define CLK_t5  8.95    /*Ancho del pulso en la prueba 5*/